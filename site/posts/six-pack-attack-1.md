...
All I really ask is to respect the contents for other people and don't be a problem.  Use them, make copies if you want (they probably aren't completely done yet either) they are just Google sheets for the "Punk You!" module initially and as practice for building characters out.  Letting me test the system some.